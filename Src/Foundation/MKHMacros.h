...
#define MKH_isNonZeroData(object) (MKH_isClassOfObject([NSData class], object) && MKH_isNonZeroLength(object))
#define MKH_isNonZeroString(object) (MKH_isClassOfObject([NSString class], object) && MKH_isNonZeroLength(object))
